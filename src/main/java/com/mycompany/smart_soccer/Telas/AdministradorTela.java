...
import com.mycompany.smart_soccer.Copa;
import com.mycompany.smart_soccer.DAO.*;
...
public class AdministradorTela extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.setBackground(new java.awt.Color(248, 195, 1));
        jPanel1.setPreferredSize(new java.awt.Dimension(1000, 550));

        jPanel2.setBackground(new java.awt.Color(15, 51, 190));
        ...
        jLabel1.setFont(new java.awt.Font("Calisto MT", 1, 40)); // NOI18N
        ...
        jButton3.setBackground(new java.awt.Color(43, 168, 253));
        ...
        jButton2.setText("« Tela Anterior");
        ...
        jButton6.setBackground(new java.awt.Color(43, 168, 253));
        ...
        jLabel6.setText("Limpar Grupos e Times");
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        if (!g.verificarGrupos()) {
            ...
            JOptionPane.showMessageDialog(null, "Cadastre os 8 grupos antes de cadastrar os times!",
                    "Ação não Permitida", JOptionPane.ERROR_MESSAGE);
        }
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        ...
        g.limparGrupos();
        t.limparTimes();
        JOptionPane.showMessageDialog(null, "Banco de Dados zerado, cadastre os "
                + "grupos e times novamente", "Reset concluído", JOptionPane.HEIGHT);
