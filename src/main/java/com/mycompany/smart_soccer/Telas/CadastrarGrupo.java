...
public class CadastrarGrupo extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setBackground(new java.awt.Color(202, 58, 66));

        jPanel1.setBackground(new java.awt.Color(15, 51, 190));

        jLabel1.setBackground(new java.awt.Color(255, 255, 255));
        jLabel1.setFont(new java.awt.Font("Segoe UI", 1, 36)); // NOI18N
        jLabel1.setForeground(new java.awt.Color(255, 255, 255));
        jLabel1.setText("Cadastro de um novo Grupo");
        ...
        jPanel3.setBackground(new java.awt.Color(248, 195, 1));
        ...
        jLabel3.setText("Grupos Cadastrados");
        ...
        jTextArea2.setBackground(new java.awt.Color(15, 51, 190));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
        String nomeDoGrupo = jTextField1.getText();
        if("".equals(nomeDoGrupo)) {
            JOptionPane.showMessageDialog(null, "Você precisa preencher o Campo 'Nome do Grupo' primeiro");
        } else {
            Grupo g = new Grupo();
            g.cadastrarGrupo(nomeDoGrupo);

            jTextField1.setText("");

            JOptionPane.showMessageDialog(null, "Grupo Cadastrado com sucesso!\nApós adastradar todos os 8 "
            + "Grupos, você poderá começar a cadastrar os times!", "Cadastro Concluido", JOptionPane.INFORMATION_MESSAGE);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CadastrarGrupo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
