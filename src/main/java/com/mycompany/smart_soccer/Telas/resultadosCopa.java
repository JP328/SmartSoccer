...
public class resultadosCopa extends javax.swing.JFrame {

    public resultadosCopa() {
        initComponents();
        this.setLocationRelativeTo(null);        
    }
    
    public void configurarTela(String vencedorCopa) {
        Time t = new Time();
        ...
        jLabel2.setText(vencedorCopa + " é o vencedor da Copa do Mundo!");
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Resultado da Copa");
        ...
        jToggleButton1.setBackground(new java.awt.Color(43, 168, 253));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(resultadosCopa.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new resultadosCopa().setVisible(true);
            }
        });
    }
